...
fun PowerTrainingDetailComposable(navController: NavController) {
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.training_detail_exercise_list),
                color = Color.White
            )
            Icon(
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.training_detail_exercise_pack_list),
                color = Color.White
            )
            Icon(
                painter = painterResource(id = R.drawable.right_arrow),
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.training_detail_dates_list),
                color = Color.White
            )
            Icon(
                painter = painterResource(id = R.drawable.right_arrow),
